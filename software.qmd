...
-   Estimates association and coordination between two time series that may have shifting features (dyadic nonverbal behavior, physiology, etc.)
    ...
    ![Simulated dyadic data, with statistical features that change over time](/images/software_timeseries.png)

-   Plots windowed cross correlation

    ![Windowed cross correlation plot for dyadic electrocardiogram data](/images/software_wcc.png)

-   Assists researchers in selecting optimal parameters for such estimation

    ![Checking for parameter spread across a subset of dyads from electrocardiograph data](/images/software_heatmap.png)
