...
![](/images/Chadha-Sareena.jpeg){fig-align="left" width="1500"}
...
[[Email 📬](mailto:sareena.chadha@dartmouth.edu)]{style="display: inline-block; font-size: 24px; color: #000000; background: #ffffff; border-radius: 6px; padding: 10px 20px;"} [[Scholar 🎓](https://scholar.google.com/citations?user=K9E3m8MAAAAJ&hl=en)]{style="display: inline-block; font-size: 24px; color: #000000; background: #ffffff; border-radius: 6px; padding: 10px 20px;"} [[ORCID 🆔](https://orcid.org/0000-0002-1301-4554)]{style="display: inline-block; font-size: 24px; color: #000000; background: #ffffff; border-radius: 6px; padding: 10px 20px;"} [[LinkedIn 🗂️](https://orcid.org/0000-0002-1301-4554)]{style="display: inline-block; font-size: 24px; color: #000000; background: #ffffff; border-radius: 6px; padding: 10px 20px;"}
:::
